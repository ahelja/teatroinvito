	...
	function dataToHtml(data) {
		...
		if (data.embed) {
			...
			if (data.type == "iframe") {
				...
				html += '<iframe src="/teatroinvito/v4/' + data.source1 + '" width="' + data.width + '" height="' + data.height + '"' + allowFullscreen + '></iframe>';
			} else if (data.source1mime == "application/x-shockwave-flash") {
				html += '<object data="' + data.source1 + '" width="' + data.width + '" height="' + data.height + '" type="application/x-shockwave-flash">';

				if (data.poster) {
					html += '<img src="/teatroinvito/v4/' + data.poster + '" width="' + data.width + '" height="' + data.height + '" />';
				}
				...
				if (editor.settings.audio_template_callback) {
					...
					html += (
						'<audio controls="controls" src="/teatroinvito/v4/' + data.source1 + '">' +
							(data.source2 ? '\n<source src="/teatroinvito/v4/' + data.source2 + '"' + (data.source2mime ? ' type="' + data.source2mime + '"' : '') + ' />\n' : '') +
						'</audio>'
					);
				}
			} else if (data.type == "script") {
				html += '<script src="/teatroinvito/v4/' + data.source1 + '"></script>';
			} else {
				if (editor.settings.video_template_callback) {
					...
					html = (
						'<video width="' + data.width + '" height="' + data.height + '"' + (data.poster ? ' poster="' + data.poster + '"' : '') + ' controls="controls">\n' +
							'<source src="/teatroinvito/v4/' + data.source1 + '"' + (data.source1mime ? ' type="' + data.source1mime + '"' : '') + ' />\n' +
							(data.source2 ? '<source src="/teatroinvito/v4/' + data.source2 + '"' + (data.source2mime ? ' type="' + data.source2mime + '"' : '') + ' />\n' : '') +
						'</video>'
					);
				}
			}
